...
<div style='background-color:#f6f7f7;height:100%'>
    ...
    <div v-for='(item,index) in list' :key='index'>
        ...
        <div class="replyMassageWrap" v-if='item.showMassages'>
            <div  v-for='detailMsg,curindex in item.replys'>
                
                <div calss='replyMassage' v-if="curindex === 0">
                    <p>{{detailMsg.content}}</p>
                    <div @click='rotate(item)' :class="item.rotates && 'rotateSan'"><img src="../common/image/shouye/xiasanjiao@2x.png" alt=""></div>
                </div>
                <ul class="moreMassage" v-if='item.rotates' >
                    <li>
...
export default {
    ...
    methods:{
        ...
        rotate(item){
            // item.rotates = !item.rotates;
            this.$set(item,'rotates',!item.rotates)
            // console.log(item.rotates)
